    ...
    if (image != null) {
      ...
      if (isConnected) {
        ...
        try {
          ...
          final DocumentReference userRef = FirebaseFirestore.instance.collection('usuarios').doc(userEmail);
...
class _UpdatePerfilState extends State<UpdatePerfil> {
  ...
  Future<void> _saveUser() async {
    ...
    if (isConnected) {
      ...
      try {
        // Use um identificador único, como o email, para obter a referência do documento
        final DocumentReference userRef = FirebaseFirestore.instance.collection('usuarios').doc(_email.text);
